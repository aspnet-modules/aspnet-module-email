...
internal class RazorViewToEmailHtmlRenderer : IRazorViewToEmailHtmlRenderer
{
    private readonly IRazorViewEngine _viewEngine;
    private readonly ITempDataProvider _tempDataProvider;
    private readonly IServiceProvider _serviceProvider;

    public RazorViewToEmailHtmlRenderer(
    ...
    public async Task<string> RenderViewToStringAsync<TModel>(string viewName, TModel model, CancellationToken ct)
    {
